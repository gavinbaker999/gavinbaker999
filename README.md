...
A Raspbery PI 5 runs mainly as a media server (Jellyfin), print server (CUPS), MQTT message broker, NAS backup server (Samba) and an object detection system using the OpenCV, Tensor Flow and Panda libraries. My home network, also has Raspberry PI Zeros that run the Weather Station and robotic projects. I also use Raspberry Pi Picos in various data collection projects.
